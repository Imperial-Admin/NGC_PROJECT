    ...
    <main className="fixed inset-0 w-full h-full bg-[#050505] text-white flex items-center justify-center font-serif overflow-hidden p-6">
      ...
      <div className="relative z-10 w-full max-w-[600px]">
        ...
        <div className="w-full bg-white/[0.02] border border-[#b38f4a]/30 p-12 backdrop-blur-xl shadow-[0_0_80px_-20px_rgba(0,0,0,1)] relative rounded-sm">
            ...
            {/* כפתור תשלום: מחזיר לדף ההעלאה עם סימון הצלחה */}
            <button 
            ...
            >
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ background: `linear-gradient(110deg, transparent 30%, rgba(255,255,255,0.5) 45%, rgba(255,255,255,0.1) 50%, transparent 60%)`, backgroundSize: '200% 100%', animation: 'shimmer 2.5s infinite linear' }}></div>
                <span className="relative flex items-center justify-center gap-4 text-[#1a0f00] text-[11px] font-black uppercase tracking-[0.6em]">Secure Payment</span>
            </button>
            ...
            <div className="mt-10 flex flex-col items-center gap-6">
                <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-[9px] tracking-[0.3em] font-black text-[#f1e4d1]">
                    <span>MASTERCARD</span><span>VISA</span><span>DINERS</span><span>AMEX</span>
                    <div className="h-3 w-[1px] bg-[#b38f4a]/40 hidden md:block"></div>
                    <span className="text-[#b38f4a]">BITCOIN</span><span className="text-[#b38f4a]">ETH</span><span className="text-[#b38f4a]">USDT</span>
                </div>
                <div className="flex items-center gap-3">
                    <Lock className="w-3.5 h-3.5 text-[#b38f4a]" strokeWidth={2} />
                    <p className="text-[8px] tracking-[0.4em] uppercase text-white font-bold">Secure Encrypted Imperial Transaction</p>
                </div>
            </div>
        </div>
      </div>
