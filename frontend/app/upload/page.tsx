        ...
        {status === 'details' && imageSrc && (
          <div className="w-full flex flex-col items-center gap-6 animate-in zoom-in-95 duration-500">
            ...
            <div className="w-full max-w-md space-y-4">
              <input type="text" placeholder="NAME" value={title} maxLength={15} onChange={e => setTitle(e.target.value)} className="w-full bg-transparent border-b border-[#b38f4a]/20 py-2 text-center text-xs tracking-[0.4em] uppercase text-white font-bold" />
              <input type="text" placeholder="LEGACY MESSAGE" value={subtitle} maxLength={100} onChange={e => setSubtitle(e.target.value)} className="w-full bg-transparent border-b border-[#b38f4a]/20 py-2 text-center text-[10px] tracking-[0.3em] uppercase text-white italic" />
            </div>
